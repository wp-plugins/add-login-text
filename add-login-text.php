...
*/
if (!defined('ALT_PLUGIN_NAME')) {
	// plugin constants
	define('ALT_PLUGIN_NAME', 'Add Login Text');
	define('ALT_VERSION', '0.0.8');
...
function alt_page() {
	...
	?>
	<div class="wrap">
		<h2 id="plugintitle"><img src="<?php echo alt_getimagefilename('login.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php echo ALT_PLUGIN_NAME; _e(' by ', alt_get_local()); ?><a href="http://www.jimmyscode.com/">Jimmy Pe&ntilde;a</a></h2>
		...
		<?php settings_fields(ALT_OPTIONS_NAME); ?>
			...
			<?php if ($active_tab == 'settings') { ?>
				<h3 id="settings"><img src="<?php echo alt_getimagefilename('settings.png'); ?>" title="" alt="" height="61" width="64" align="absmiddle" /> <?php _e('Plugin Settings', alt_get_local()); ?></h3>
				...
				<?php submit_button(); ?>
			<?php } else { ?>
				<h3 id="support"><img src="<?php echo alt_getimagefilename('support.png'); ?>" title="" alt="" height="64" width="64" align="absmiddle" /> <?php _e('Support', alt_get_local()); ?></h3>
				<div class="support">
